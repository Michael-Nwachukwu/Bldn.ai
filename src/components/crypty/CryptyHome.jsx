                                        ...
                                        <Box>
                                            <Stat>
                                                <Flex direction={'column'} align={'end'} justify={'end'}>
                                                    ...
                                                    <small style={{ color: colorMode == 'light' ? 'white' : '#888b8d' }}>Feb 24, 2018 (almost 6 years)</small>
                                                </Flex>
                                            </Stat>
                                        </Box>
                                    </Flex>
                                        ...
                                        <Box>
                                            <Stat>
                                                <Flex direction={'column'} align={'end'} justify={'end'}>
                                                    ...
                                                    <small style={{ color: colorMode == 'light' ? 'white' : '#888b8d' }}>Feb 24, 2018 (almost 10 years)</small>
                                                </Flex>
                                            </Stat>
                                        </Box>
                                    </Flex>
