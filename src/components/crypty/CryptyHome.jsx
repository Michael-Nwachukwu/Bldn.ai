                    ...
                    <Flex direction={'column'} alignItems={'end'} gap={2}>
                        <Flex alignItems={'center'} gap={3}>
                            <small style={{ color:'#dfe5ed' }}>
                                Cryptos: <span style={{ color:'#f8c6a9' }}>2M+</span>
                            </small>
                            <small style={{ color:'#dfe5ed' }}>
                                Exchanges: <span style={{ color:'#f8c6a9' }}>687</span>
                            </small>
                            <small style={{ color:'#dfe5ed' }}>
                                Dominance: <span style={{ color:'#f8c6a9' }}>BTC: 51.4% ETH: 16.8%</span>
                            </small>
                            <small style={{ color:'#dfe5ed' }}>
                                ...
                                <span style={{ color:'#f8c6a9' }}>52 GWEI </span>
                                </Flex>
                            </small>
                        </Flex>
                        <Flex alignItems={"center"} gap={3}>
                            <Tag size={'md'} colorScheme='brand' py={1} _hover={{ 
                                color:'brand.300',
                             }}>
                                ...
                                <List w={'100%'} spacing={2.5} mt={2.5} color={color}>
                                    <ListItem>
                                        <Flex alignItems={'center'}>
                                            ...
                                            <Spacer />
                                            <Text>1.56568341</Text>
                                            <Tag ml={2} py={0.5} colorScheme='brand'>
                                                <TagLabel>
                                                    Ftm
                                                </TagLabel>
                                            </Tag>
            ...
            <Grid templateColumns='repeat(5, 1fr)' gap={2} mt={6}>
                    ...
                    <Card bg={'#191e22'} borderRadius={15}>
                        <CardBody>
                            ...
                            <List w={'100%'} spacing={3} mt={5}>
                                ...
                                <ListItem>
                                    <Flex justify={'space-between'} align={'center'}>
                                        <Text color={'#888b8d'}>All-Time High</Text>
                                        <Box>
                                            <Stat>
                                                <Flex direction={'column'} align={'end'} justify={'end'}>
                                                    <Flex align={'center'} fontWeight={'bold'} gap={1.5} mb={-2}>
                                                        <StatNumber fontSize={'md'}>$89.14 </StatNumber>
                                                        <StatHelpText color={'red'} fontSize={'md'} pt={2}>
                                                            -23.36%
                                                            <StatArrow color={'red'} type='decrease' />
                                                        </StatHelpText>
                                                    </Flex>
                                                    <small style={{ color:'#888b8d' }}>Feb 24, 2018 (almost 6 years)</small>
                                                </Flex>
                                            </Stat>
                                        </Box>
                                    </Flex>
                                ...
                                <ListItem>
                                    <Flex justify={'space-between'} align={'center'}>
                                        <Text color={'#888b8d'}>All-Time Low</Text>
                                        <Box>
                                            <Stat>
                                                <Flex direction={'column'} align={'end'} justify={'end'}>
                                                    <Flex align={'center'} fontWeight={'bold'} gap={1.5} mb={-2}>
                                                        <StatNumber fontSize={'md'}>$21.10 </StatNumber>
                                                        <StatHelpText color={'red'} fontSize={'md'} pt={2}>
                                                            -86.40%
                                                            <StatArrow color={'red'} type='increase' />
                                                        </StatHelpText>
                                                    </Flex>
                                                    <small style={{ color:'#888b8d' }}>Feb 24, 2018 (almost 10 years)</small>
                                                </Flex>
                                            </Stat>
                                        </Box>
                                    </Flex>
                            ...
                            <Card bg={"#0e1217"} opacity={'60%'} borderRadius={20} h={48} mt={5}>
                                <CardBody>
                                    <Flex direction={'column'} justify={'space-between'}>
                                        ...
                                        <Flex justify={'end'} mt={6}>
                                            <Flex align={'center'} gap={1.5} fontSize={'sm'} fontWeight={'light'}>
                                                Genereated by 
                                                <svg width="20" height="20" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-2/3 w-2/3" role="img">
                ...
                <GridItem colSpan={3} w={'100%'}>
                    ...
                    <Box p={3}>
                        ...
                        <Text h={64} overflow={'scroll'} color={'#9fa0a2'} fontWeight={'light'}>
